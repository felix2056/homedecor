...
<main class="wrapper main-content" role="main">
    ...
    <div id="shopify-section-list-collections-template" class="shopify-section">
        ...
        <div class="grid text-center list-collections-template" data-section-id="list-collections-template"
            ...
            <div class="grid-item small--one-half one-third">
                ...
                <a href="/collections/decor" title="Browse our Decor collection" class="featured-box">
                    <div class="featured-box--inner" style="height: 281px;">
            ...
            <div class="grid-item small--one-half one-third">
                ...
                <a href="/collections/dining" title="Browse our Dining collection" class="featured-box">
                    <div class="featured-box--inner" style="height: 281px;">
                        <div class="featured-box--image  vertical-middle">
                            ...
                            <div id="" class="lazyload__image-wrapper no-js" style="max-width: 310px;">
                                <div style="padding-top:100.0%;">
                                    <img class="no-js lazyautosizes lazyloaded"
                                        data-widths="[125, 180, 360, 540, 720, 900, 1080, 1296, 1512, 1728, 2048]"
                                        data-aspectratio="1.0" data-sizes="auto" alt="kitchen Dining Room Wall Sticker"
                    ...
                    <span class="featured-box--title" style="height: 29px;">Dining</span>
                </a>
            </div>
            ...
            <div class="grid-item small--one-half one-third">
                ...
                <a href="/collections/kitchen" title="Browse our Kitchen collection" class="featured-box">
                    ...
                    <span class="featured-box--title" style="height: 29px;">Kitchen</span>
                </a>
            </div>
