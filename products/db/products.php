...
$product43['meta'] = array(
    ...
    "material" => "Wood",
    "theme" => "Flower",
    "surface_technology" => "Polish",
    "carving" => "Relief",
    "material_texture" => "Rubberwood",
...
$product48['meta'] = array(
    ...
    "scenerios" => "Wall",
    "pattern" => "Plane Wall Sticker",
    "features" => "Carving (non-printed), Waterproof",
    "purpose" => "Italian Version Wall Sticker Kitchen Decoration"
);
...
$product52['meta'] = array(
    ...
    "theme" => "Pattern",
    "pattern" => "Plane Wall Sticker",
    "classification" => "For Wall,For Tile,For Cabinet Stove",
    "specification" => "Single-piece Package"
);
